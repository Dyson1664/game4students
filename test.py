...
#
# # Initialize database (this will create the database and table if they don't exist)
# # db_ops.initialize_db()
#
# # Add a question
# # db_ops.add_question('What is the capital of France?')
#
...
s1 = Student('Dave', 33, 90)
s2 = Student('John', 30, 45)
s3 = Student('Bob', 19, 98)
...
#ecapusaltion allows variable to be run with the same name without interferring with each other
